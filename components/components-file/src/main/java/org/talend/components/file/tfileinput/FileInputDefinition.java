...
import org.talend.components.file.runtime.reader.FileInputSource;
...
public class FileInputDefinition extends AbstractComponentDefinition {
    ...
    public RuntimeInfo getRuntimeInfo(ExecutionEngine engine, ComponentProperties properties, ConnectorTopology connectorTopology) {
        ...
        return new SimpleRuntimeInfo(this.getClass().getClassLoader(), DependenciesReader.computeDependenciesFilePath("org.talend.components", "components-file"), FileInputSource.class.getCanonicalName());
    }
