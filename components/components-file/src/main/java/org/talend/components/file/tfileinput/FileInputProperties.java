...
public class FileInputProperties extends FixedConnectorsComponentProperties {
	...
	/**
	 * Stores path to file to be read Note: property <code>name</code>, which is
	 ...
	 */
	protected final transient PropertyPathConnector mainConnector = new PropertyPathConnector(Connector.MAIN_NAME,
			"schema"); //$NON-NLS-1$
