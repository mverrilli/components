...
import com.netsuite.webservices.v2016_2.setup.customization.types.CustomRecordTypePermissionsPermittedLevel;
import com.netsuite.webservices.v2016_2.setup.customization.types.CustomRecordTypePermissionsRestriction;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="permittedRole" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="permittedLevel" type="{urn:types.customization_2016_2.setup.webservices.netsuite.com}CustomRecordTypePermissionsPermittedLevel" minOccurs="0"/&gt;
 *         &lt;element name="restriction" type="{urn:types.customization_2016_2.setup.webservices.netsuite.com}CustomRecordTypePermissionsRestriction" minOccurs="0"/&gt;
 *         &lt;element name="defaultForm" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="restrictForm" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="searchForm" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="searchResults" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="listView" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="listViewRestricted" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="dashboardView" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="restrictDashboardView" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="sublistView" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
...
public class CustomRecordTypePermissions {
     ...
     * This getter has been renamed from isRestrictForm() to getRestrictForm() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     ...
     * This getter has been renamed from isListViewRestricted() to getListViewRestricted() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     ...
     * This getter has been renamed from isRestrictDashboardView() to getRestrictDashboardView() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     ...
     * This getter has been renamed from isRestrictSublistView() to getRestrictSublistView() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
