 ...
 * generated in the com.netsuite.webservices.v2016_2.lists.website package. 
...
public class ObjectFactory {
    ...
    private final static QName _SiteCategory_QNAME = new QName("urn:website_2016_2.lists.webservices.netsuite.com", "SiteCategory");
    private final static QName _SiteCategorySearch_QNAME = new QName("urn:website_2016_2.lists.webservices.netsuite.com", "siteCategorySearch");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.netsuite.webservices.v2016_2.lists.website
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:website_2016_2.lists.webservices.netsuite.com", name = "SiteCategory")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:website_2016_2.lists.webservices.netsuite.com", name = "siteCategorySearch")
