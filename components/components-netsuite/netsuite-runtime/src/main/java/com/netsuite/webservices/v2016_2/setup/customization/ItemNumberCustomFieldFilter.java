...
import com.netsuite.webservices.v2016_2.setup.customization.types.CustomizationFilterCompareType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="fldFilter" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *         &lt;element name="fldFilterChecked" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="fldFilterCompareType" type="{urn:types.customization_2016_2.setup.webservices.netsuite.com}CustomizationFilterCompareType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="fldCompareField" type="{urn:core_2016_2.platform.webservices.netsuite.com}RecordRef" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ItemNumberCustomFieldFilter {
     ...
     * This getter has been renamed from isFldFilterChecked() to getFldFilterChecked() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     ...
     * This getter has been renamed from isFldFilterNotNull() to getFldFilterNotNull() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     ...
     * This getter has been renamed from isFldfilterNull() to getFldfilterNull() by cxf-xjc-boolean plugin.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
