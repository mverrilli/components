...
public enum RecordTypeEnum implements RecordTypeEx {
  ...
  CRM_CUSTOM_FIELD("crmCustomField", "CrmCustomField", CrmCustomField.class, "item"),
  ...
  CUSTOM_RECORD("customRecord", "CustomRecord", CustomRecord.class, null),

  CUSTOM_RECORD_CUSTOM_FIELD("customRecordCustomField", "CustomRecordCustomField", CustomRecordCustomField.class, "item"),

  CUSTOM_RECORD_TYPE("customRecordType", "CustomRecordType", CustomRecordType.class, null),

  CUSTOM_TRANSACTION("customTransaction", "CustomTransaction", CustomTransaction.class, null),
  ...
  ENTITY_CUSTOM_FIELD("entityCustomField", "EntityCustomField", EntityCustomField.class, "item"),
  ...
  ITEM_CUSTOM_FIELD("itemCustomField", "ItemCustomField", ItemCustomField.class, "item"),
  ...
  ITEM_NUMBER_CUSTOM_FIELD("itemNumberCustomField", "ItemNumberCustomField", ItemNumberCustomField.class, "item"),

  ITEM_OPTION_CUSTOM_FIELD("itemOptionCustomField", "ItemOptionCustomField", ItemOptionCustomField.class, "item"),
  ...
  OTHER_CUSTOM_FIELD("otherCustomField", "OtherCustomField", OtherCustomField.class, "item"),
  ...
  TRANSACTION_BODY_CUSTOM_FIELD("transactionBodyCustomField", "TransactionBodyCustomField", TransactionBodyCustomField.class, "item"),

  TRANSACTION_COLUMN_CUSTOM_FIELD("transactionColumnCustomField", "TransactionColumnCustomField", TransactionColumnCustomField.class, "item"),
